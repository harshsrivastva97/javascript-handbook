...
const Exercises: React.FC = () => {
  ...
  const [exercises, setExercises] = useState<Exercise[]>([
    ...
    },
    {
      ...
      description: 'Implement infinite scrolling functionality using Intersection Observer API.',
      difficulty: 'Medium',
      status: 'pending',
      requirements: [
    ...
    },
    {
      ...
      description: 'Build a custom event emitter class that allows subscription to events and emitting events with data.',
      difficulty: 'Medium',
      status: 'pending',
      requirements: [
    ...
    },
    {
      ...
      description: 'Create a debounce utility function that limits the rate at which a function can fire.',
      difficulty: 'Hard',
      status: 'pending',
      requirements: [
    ...
    },
    {
      ...
      description: 'Create a fluent API for building and manipulating DOM elements programmatically.',
      difficulty: 'Medium',
      status: 'pending',
      requirements: [
              ...
              <div
                className={`flex items-center p-3 cursor-pointer transition-all hover:bg-gray-50 w-full box-border
                  ${exercise.status === 'completed' ? 'text-green-500' :
                    exercise.status === 'in-progress' ? 'text-yellow-500' : 'text-gray-400'}`}
              >
                <div
                ...
                >
                  ...
                  <span className={`text-sm ${getDifficultyColor(exercise.difficulty)} mr-2`}>
                    {exercise.difficulty}
                  </span>
                </div>
              </div>
